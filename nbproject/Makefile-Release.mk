...
${OBJECTDIR}/socket/epoll_server.o: socket/epoll_server.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/epoll_server.o socket/epoll_server.cpp

${OBJECTDIR}/socket/poll_server.o: socket/poll_server.cpp
	${MKDIR} -p ${OBJECTDIR}/socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/poll_server.o socket/poll_server.cpp

${OBJECTDIR}/socket/select_server.o: socket/select_server.cpp
	${MKDIR} -p ${OBJECTDIR}/socket
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/socket/select_server.o socket/select_server.cpp
